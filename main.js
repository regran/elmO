...
var _user$project$Proc$Picture = F2(
	function (a, b) {
		return {ctor: 'Picture', _0: a, _1: b};
	});
var _user$project$Proc$update = F2(
	function (msg, model) {
		var _p0 = msg;
		if (_p0.ctor === 'ViewChange') {
			var _p1 = _p0._0;
			switch (_p1.ctor) {
				case 'Label':
					return {
			...
			return {
				...
				_0: _elm_lang$core$Native_Utils.update(
					model,
					{
						img: A2(_user$project$Proc$Picture, _p0._0, 'stuff')
					}),
				_1: _elm_lang$core$Platform_Cmd$none
			};
		}
	});
var _user$project$Proc$Waiting = {ctor: 'Waiting'};
var _user$project$Proc$Wait = {ctor: 'Wait'};
var _user$project$Proc$init = {
	ctor: '_Tuple2',
	_0: A5(_user$project$Proc$Model, _user$project$Proc$Waiting, _user$project$Proc$Wait, 'There will be attribute descriptions or a prompt for an image here someday', '', _elm_lang$core$Dict$empty),
	_1: _elm_lang$core$Platform_Cmd$none
};
			...
			return A2(
				_elm_lang$html$Html$img,
				{
					...
					_1: {
						...
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$title(_p2._1),
							_1: {ctor: '[]'}
						}
					}
				},
...
var Elm = {};
Elm['Proc'] = Elm['Proc'] || {};
if (typeof _user$project$Proc$main !== 'undefined') {
    _user$project$Proc$main(Elm['Proc'], 'Proc', undefined);
}
